...
<head>
    ...
    <title>NUEVO MISION Y VISION</title>
</head>
...
<?php require "nav.admin.view.php" ?>
    <div class="contenedor_form">
        <div class="post">
            <article>
                <h2 class="titulo">Nuevo Misión y Visión</h2>
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="formulario" enctype="multipart/form-data" method="post">
                    ...
                    <textarea id="txt" name="mision" placeholder="INGRESE MISIÓN"  required></textarea>

                    <label for="vision"><h3>Visión</h3></label>
                    <textarea id="txt" name="vision" placeholder="INSGRESE VISIÓN"  required></textarea>
