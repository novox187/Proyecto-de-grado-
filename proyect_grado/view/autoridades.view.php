...
<body>
    ...
    <div class="cont-master">
        ...
        <div id="docentes_tecnico" class="docentes_tecnico_inf autoridades">
            <h1 class="titulo-docentes">AUTORIDADES <span id="i-docentes"><i class="fas fa-chevron-circle-down"></i></span></h1>
                ...
                <?php foreach ($datos as $dato) { ?>
                    <div class="cont-docente">
                        ...
                        <div class="inf-docente">
                            ...
                            <h5 class="asignatura-docente h-docente">Cargo:</h5>
                            <p class="text"><?php echo $dato['cargo'] ?></p>
                        </div>
                    </div>
                <?php } ?>
