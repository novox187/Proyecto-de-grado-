    ...
    <div class="contenedor_form">
        <div class="post">
            <article>
                ...
                <?php foreach ($resultado_art as $resultado) {?>
                    <input type="hidden" name="id" value="<?php echo $resultado['id']; ?>">
                    <input type="text" name="titulo" value="<?php echo $resultado['titulo'] ?>" placeholder="Ingresa Un Titulo" maxlength="50" required>
                    <textarea id="txt" name="estracto" placeholder="INGRESA EL ESTRACTO
recuerda que tienes un maximo de 400 caracteres" maxlength="400" required><?php echo $resultado['estracto'] ?></textarea>
                    <textarea id="txt" name="contenido" placeholder="INSGRESA EL CONTENIDO"  required><?php echo $resultado['contenido'] ?></textarea>
                    <input type="text" name="autor" value="<?php echo $resultado['autor'] ?>" placeholder="Ingrese su nombre"  required>

                <?php }?>
                    <input type="file" name="img" >
                    <input type="hidden" name="img_guardada" value="<?php echo $resultado['img'] ?>">
