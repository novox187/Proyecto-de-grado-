...
<body onload="contadorCaracteres()">
    ...
    <div class="contenedor_form">
        <div class="post">
            <article>
                <h2 class="titulo">Nuevo Banner</h2>
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="formulario" enctype="multipart/form-data" method="post">
                    ...
                    <textarea id="txt" name="texto" placeholder="-Ingresa el Contenido
-recuerda que tienes un maximo de 600 palabras" maxlength="600" required></textarea>
                    <input type="text" name="autor" placeholder="Ingrese su nombre"  required>
                    <input type="file" name="img" required>
                    <input type="submit" value="Crear Banner">
                </form>
